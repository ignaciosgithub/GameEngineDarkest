...
void Engine::CreateDemoScene() {
    ...
    auto* cameraTransform = m_world->AddComponent<TransformComponent>(cameraEntity, Vector3(0, 8, 12));
    
    Quaternion lookDownRotation = Quaternion::FromAxisAngle(Vector3::Right, -0.4f);
